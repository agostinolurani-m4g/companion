...
import V2Explore from "@/components/v2/V2Explore";
import { getCurrentSessionEmail, isAdminUser, isV2BetaUser } from "@/lib/auth";

export const dynamic = "force-dynamic";
export const runtime = "nodejs";

export default async function V2ExplorePage() {
  ...
  return (
    <Suspense fallback={<div className="p-4 text-sm text-[color:var(--hmr-muted)]">Caricamento…</div>}>
      <V2Explore isAdmin={isAdminUser(sessionEmail)} username={sessionEmail} />
    </Suspense>
  );
}
